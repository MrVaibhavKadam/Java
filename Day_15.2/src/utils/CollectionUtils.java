...
public class CollectionUtils {
	//add static method to return populated map
	public static HashMap<Integer, Student>populateMap()
	{
		...
		List<Address> addresses=Arrays.asList(new Address("pune", "MH", "452446"),new Address("nagpur", "MH", "852446"),
				new Address("indore", "MP", "752446"),new Address("mumbai", "MH", "672446"));
		
		int i=0;
		for(Student s:hm.values())
			s.assignAddress(addresses.get(i++));
		
		return hm;//return populated students assigned to the address to caller.
	}
