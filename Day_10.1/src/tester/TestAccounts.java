...
import custome_ordering.BankAccountDateTypeComparator;
				...
				try {
					System.out.println(
							"Menu 1.Create New A/C 2.Display 3.Check if a/c exists 4.Fetch Account summary. 5.Link KYC"
									+ " 6.Apply Interest 7.Close A/C 10.BankAccountDateTypeComparator 11.sort by date Anonymous inner cls 100.Exit");
...
//						//acctNo.equals(a1):false ..coz calling Integer cls's equals method=>false since Integer is of type int and BankAccount is of type string.so they are incompatable.
					...
					case 6:// Applying interest on saving accounts
						...
						for (BankAccount a1 : accts)
							if (a1.getAcctType().equals(SAVING))// you can use .equals(SAVING) directly but we have to
...
//						break;
					case 10:
						// sort as per creation date and a/c type.
						BankAccountDateTypeComparator comp = new BankAccountDateTypeComparator();
						Collections.sort(accts, comp);

						break;
					case 11:// sort accts as per date using anonymous class.
						//new Comparator<BankAccount>()=>instance of the cls who implements Comparator
						Collections.sort(accts, new Comparator<BankAccount>() {
							@Override
							public int compare(BankAccount o1, BankAccount o2) {
								System.out.println("nother inner class : compare");
